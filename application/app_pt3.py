...
page = st.sidebar.radio("Navigate", ["📊 Project Overview", "📥 Predict From CSV", "📈 Visualizations"])
st.sidebar.markdown("---")
...
if page == "📥 Predict From CSV":
    ...
    MODEL_PATH = r"C:\Users\nyele\Desktop\ITDMA - RESEARCH - PROJECT\Apple_WWDC_Dashboard\data\chunked_svm_balanced_model.pkl"
    VECTORIZER_PATH = r"C:\Users\nyele\Desktop\ITDMA - RESEARCH - PROJECT\Apple_WWDC_Dashboard\data\chunked_tfidf_vectorizer.pkl"
    ...
    st.markdown("---")
    st.markdown("👩🏽‍💻 *Model trained by Ctrl Alt Elite — Data Science Project (Eduvos)*")
...
if page == "📈 Visualizations":
    ...
    # Load dataset
    data_path = r"C:\Users\nyele\Desktop\ITDMA - RESEARCH - PROJECT\Apple_WWDC_Dashboard\data\combined_cleaned_dataset_2025-10-26_21-32_labeled.csv"
